...
echo "<br> ZrobBaze END";
} 
ZrobBaze();

function ZrobTabele() {

echo "<br> Zrob Tabele start";
$BUTY = "
CREATE TABLE buty
...
try{
 echo"<br> Rozpoczynam wypełnianie tabeli butów";
